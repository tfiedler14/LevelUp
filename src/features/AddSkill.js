...
export const AddSkill = ({ auth, skills, setLocation, location, handleSubmit, putData}) => {
                    ...
                    <View>
                        <Button
                            ...
                            onPress={handleSubmit(values => {
                                handleAttribute(auth, values, setLocation, putData);
                            })}>Save Skill</Button>
...
const handleAttribute = (auth, values, setLocation, putData) => {
