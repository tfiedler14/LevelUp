                ...
                <View style={styles.buttons}>
                  <Button
                    ...
                    onPress={handleSubmit(values => {
                      handleLogin(values, setLocation, setAuthentication, setErrors, errors);
                    })}>
                    Sign In
                  </Button>
                  <Button
...
const handleLogin = (values, setLocation, setAuth, setErrors, errors) => {
  firebaseApp
    .auth()
